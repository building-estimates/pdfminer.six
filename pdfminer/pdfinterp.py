...
class PDFPageInterpreter:
    ...
    def init_state(self, ctm: Matrix, mediabox: Rect) -> None:
    ...
    def get_current_state(self) -> Tuple[Matrix, List, bool, PDFTextState, PDFGraphicState]:
        return (self.ctm, self.ccp, self.ccp_flag_on, self.textstate.copy(), self.graphicstate.copy())

    def set_current_state(
        self, state: Tuple[Matrix, List, bool, PDFTextState, PDFGraphicState]
    ) -> None:
        (self.ctm, self.ccp, self.ccp_flag_on, self.textstate, self.graphicstate) = state
        self.device.set_ctm(self.ctm)
        return
